...
pub mod ai_code {
    ...
    // API features
    pub const ENABLE_FINE_GRAINED_TOOL_STREAMING: &str =
        "AI_CODE_ENABLE_FINE_GRAINED_TOOL_STREAMING";
...
pub mod ai_code_model {
    ...
    pub const DEFAULT_HAIKU_MODEL_SUPPORTED_CAPABILITIES: &str =
        "AI_DEFAULT_HAIKU_MODEL_SUPPORTED_CAPABILITIES";
    pub const DEFAULT_OPUS_MODEL: &str = "AI_DEFAULT_OPUS_MODEL";
    ...
    pub const DEFAULT_OPUS_MODEL_SUPPORTED_CAPABILITIES: &str =
        "AI_DEFAULT_OPUS_MODEL_SUPPORTED_CAPABILITIES";
    pub const DEFAULT_SONNET_MODEL: &str = "AI_DEFAULT_SONNET_MODEL";
    ...
    pub const DEFAULT_SONNET_MODEL_SUPPORTED_CAPABILITIES: &str =
        "AI_DEFAULT_SONNET_MODEL_SUPPORTED_CAPABILITIES";
}
