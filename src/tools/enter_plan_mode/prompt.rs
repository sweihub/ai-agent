...
Plan mode is valuable when the implementation approach is genuinely ambiguous. Use it when:
...
/// Get the EnterPlanMode tool prompt, variant based on USER_TYPE env var.
