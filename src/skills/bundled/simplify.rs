// Source: /data/home/swei/claudecode/openclaudecode/src/skills/bundled/simplify.ts
//! Simplify skill - ported from openclaudecode/src/skills/bundled/simplify.ts
//!
